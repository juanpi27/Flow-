...
public class FlowDrawer {
	...
	class FlowPanel extends JPanel
	{
		...
		public void paintComponent(Graphics g) {
			...
			for(FlowShape thing:listOfCommands)
			{
				if(thing.getShape().equalsIgnoreCase("diam")){
					...
					flowDiamond(g,thing.getName(),thing.getPositionX(),thing.getPositionY(),thing.getNext());
				}
		...
		private void ifArrow(Graphics g, int x, int y)
		{
			...
			g.drawLine(x+100,y-100, x+260,y-100);
			g.drawLine(x+260,y-100, x+260,y+100);
			g.drawLine(x+260,y+100, x+250,y+90);
			g.drawLine(x+260,y+100, x+270,y+90);
			g.drawString("no", x+240,y+50);
